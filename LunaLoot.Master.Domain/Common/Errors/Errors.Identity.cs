...
public static partial class Errors
{
    public static class Identity
    {
        public static Error DuplicateEmailError(string email)
            => Error.Conflict(code: "Product.DuplicateEmail", description: $"{email} already exists");
        public static Error UserDoesNotExistError
            => Error.NotFound(code: "Product.UserDoesNotExist", description: "User does not exist");

        public static Error InvalidCredentials
            => Error.Validation(code: "Product.InvalidCredentials", description: "Provided credentials are invalid");
